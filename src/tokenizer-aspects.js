...
class TokenizerAspects extends Tokenizer {
  constructor(container, shouldTokenize, aspects) {
  ...
  buildDictionary() {
    this.dict = {};
    for (let i = 0; i < this.aspects.length; i += 1) {
      this.addToTree(this.aspects[i]);
    }
  }
...
module.exports = TokenizerAspects;
